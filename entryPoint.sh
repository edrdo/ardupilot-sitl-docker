...
sim_vehicle.py -N -v ArduCopter --frame=hexa -L $START_LOCATION /external/$PARAM_FILE -w --model hexa --no-mavproxy --sitl-instance-args="-S --base-port $GCS_PORT" $SIM_OPTIONS
